...
Canonical domain vocabulary and cross-feature rules for WaveFit.

| Document                               | Content                                                                                                                     |
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [overview.md](overview.md)             | Product/domain overview, the two branches (template/tracking), the active-container model, offline behavior at a high level |
